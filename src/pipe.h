 ...
 * @background: If true, the parent does not wait for the children;
 *              the pipeline runs entirely in the background.
 *
 ...
 * The parent closes all pipe file descriptors.
 * In foreground mode the parent waits for every child.
 */
